...
console.log('#app1');
console.log((0, _jquery.default)('#app1')); // 数据相关的放到m
...
var c = {
  ...
  bindEvents: function bindEvents() {
    ...
    v.container.on('click', '#btnAdd', function () {
      m.data.n += 1;
      localStorage.setItem('n', m.data.n);
      v.render();
    });
    v.container.on('click', '#btnMinus', function () {
      m.data.n -= 1;
      localStorage.setItem('n', m.data.n);
      v.render();
    });
    v.container.on('click', '#btnMul', function () {
      m.data.n *= 2;
      localStorage.setItem('n', m.data.n);
      v.render();
    });
    v.container.on('click', '#btnDivide', function () {
      m.data.n /= 2;
      localStorage.setItem('n', m.data.n);
      v.render();
    });
...
_app.default.init('#app1'); // const img = document.querySelector('.image')
// img.remove()
